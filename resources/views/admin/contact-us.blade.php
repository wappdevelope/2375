    ...
    <section>
        ...
        <div class="table-responsive">
            ...
            <table class="table align-middle gs-0 gy-3">
                ...
                <thead>
                    <tr>
                        <th class="p-1 w-50px"><b>Full Name</b></th>
                        <th class="p-1 w-50px"><b>Email</b></th>
                        <th class="p-1 w-50px"><b>Question</b></th>
                        <th class="p-1 w-50px"><b>Change Status</b></th>
                    </tr>
                </thead>
                ...
                <tbody>
                    @foreach ($quests as $quest)
                        <tr>
                            <td class="p-1 w-50px">
                                <a href="#" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{ $quest->name }}</a>
                            </td>
                            <td class="p-1 w-50px">
                                <a href="mailto:{{ $quest->email }}"
                                    class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{ $quest->email }}</a>
                            </td>
                            <td class="p-1 w-50px">
                                <a href="#"
                            ...
                            <td class="p-1 w-50px">
                                @if ($quest->status == 0)
                                    <form action="{{ route('answer', $quest->id) }}" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-icon btn-light btn-sm me-3 remove-account" style="background-color: #2bccb1;">
        ...
        S509.502,87.794,504.969,83.262z" />
                                ...
                                @else
                                    <span class="svg-icon svg-icon-3" style="background-color: #2bccb1;">
                                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                            viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;"
                                            xml:space="preserve">
